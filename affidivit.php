...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO xerox_table (name, email, copies, file_name, file) VALUES (?, ?, ?, ?, ?)");
  ...
  <div class="body1">
        ...
        <form>
            <div class="form-group">
                <label for="value1">Enter number of copies:</label>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
    ...
    if ( pages <= 0) {
      ...
      const payAmount = localStorage.getItem('price');
      let formTitle = localStorage.getItem('formName')
      let cost = pages * payAmount;
      let mode="form";
      localStorage.setItem('paymentAmount', cost);
      localStorage.setItem('copies', pages);
      localStorage.setItem('formName', formTitle);
      localStorage.setItem('mode',mode ); // Store the amount in localStorage
