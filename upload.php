...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO files_table (name, email, number_of_copies, number_of_pages, file_name, file) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $name, $email, $copies, $pages, $fileName, $fileData);
...
margin-bottom: unset;
  ...
  /* Style for the highlighted username */
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
  <script type="text/javascript">
    localStorage.setItem('mode',"file" );
</script>
  </body>
</html>